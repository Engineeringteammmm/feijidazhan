...
HP_list = [1, 10, 45, 10]
#飞机大小
plane_size = [{"width":51, "height":39}, {"width":69, "height":89}, {"width":197, "height":134}, {"width":100, "height":124}]
#各种飞机爆炸效果换图片时间
...
bullet_supply = None
#暂停全局变量的设置
pause_image = pause_image = pygame.image.load("./feiji/btn_finish.png")
#关于子弹
#敌机子弹类型
